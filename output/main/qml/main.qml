                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        LeftMenuBtn {
                            ...
                            FileDialog{
                                ...
                                onAccepted: {
                                    ...
                                    labelRightInfo.text = fileOpen.currentFile.toString()
                                }
                                onRejected: {
                                    labelRightInfo.text = '| NEW'
                                }
                        ...
                        LeftMenuBtn {
                            ...
                            width: leftMenu.width
                            text: qsTr("Novo")
                            btnIconSource: "../images/svg_images/new_icon.svg"
                            onClicked: {
                                btnHome.isActiveMenu = false
                                btnSettings.isActiveMenu = false
                                btnNew.isActiveMenu = true
                        ...
                        LeftMenuBtn {
                            ...
                            FileDialog{
                                ...
                                onAccepted: {
                                    ...
                                    labelRightInfo.text = fileSave.currentFile.toString()
                                }
...
/*##^##
Designer {
    D{i:0;formeditorZoom:0.75}D{i:20}
}
##^##*/
